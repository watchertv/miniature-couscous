<template>
	<view class="order-status margin radius">
		...
		<view class="cu-list grid col-5 no-border">
			<view class="cu-item" @tap="linkTo" data-url="/pages/mall/order/list?state=1">
				<view class="cuIcon-pay text-red lg"></view>
				<text class="text-sm">待付款</text>
			</view>
			<view class="cu-item" @tap="linkTo" data-url="/pages/mall/order/list?state=2">
				<view class="cuIcon-deliver text-red lg"></view>
				<text class="text-sm">待发货</text>
			</view>
			<view class="cu-item" @tap="linkTo" data-url="/pages/mall/order/list?state=3">
				<view class="cuIcon-send text-red"></view>
				<text class="text-sm">待收货</text>
			</view>
			<view class="cu-item" @tap="linkTo" data-url="/pages/mall/order/list?state=4">
